...
st.markdown("""
    ...
    .stMetric, div[data-testid="stExpander"], div[data-testid="stDataFrameContainer"] {
        ...
        padding: 25px;
        border-radius: 20px;
        box-shadow: 0 10px 15px -3px rgba(30, 58, 138, 0.08), 0 4px 6px -2px rgba(30, 58, 138, 0.05); /* 影に藍色を少しブレンド */
        border: 1px solid #d1e3f3; /* 薄い藍色のボーダー */
    }
    ...
    [data-testid="stSidebar"] h1, [data-testid="stSidebar"] h3, [data-testid="stSidebar"] .stMarkdown p {
